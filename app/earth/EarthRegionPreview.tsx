...
export default function EarthRegionPreview(){
  ...
  const corridorOverlay=useMemo(()=>{
    ...
    const overlay=createSpaceportPlanningOverlay(candidateData?.shortlist??[])
      ...
      <svg viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice">
        ...
        <g ref={mapGroupRef} transform={`translate(${offset.x} ${offset.y}) scale(${zoom})`}>
          ...
          {layers.corridor&&corridorOverlay&&<g className="earth-planning-corridor" pointerEvents="none" aria-label="Korridor B · Vorprüfung · nicht kanonisch">
            ...
            <line x1={corridorOverlay.startX} y1={corridorOverlay.startY} x2={corridorOverlay.endX} y2={corridorOverlay.endY} stroke="#70571b" strokeWidth={1.8/zoom} strokeDasharray={`${8/zoom} ${6/zoom}`}/>
            <circle cx={corridorOverlay.startX} cy={corridorOverlay.startY} r={5/zoom} fill="#f0c854" stroke="#493a18" strokeWidth={1.5/zoom}/>
