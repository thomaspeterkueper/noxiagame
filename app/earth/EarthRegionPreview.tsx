...
export default function EarthRegionPreview(){
  ...
  return <div className="earth-shell">
    ...
    <div className={`earth-map ${buildTypeId?'building':''}`}
      ...
      onPointerUp={e=>{if(buildTypeId){const next=pointerToPreview(e);if(next){setPreview(next);void placeBuilding(next)};return}drag.current=null;try{e.currentTarget.releasePointerCapture(e.pointerId)}catch{}}}>
