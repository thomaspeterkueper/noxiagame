...
// Erstellt:     20.06.2026
// Aktualisiert: 24.08.2026 — POST → GET (Turbopack-POST-Bug, siehe Tech-Setup
//               "Bekannte Probleme #2"). Body-Parameter (level, isDaily, seed,
//               colonyContext) sind jetzt Query-Parameter.
// Version:      2.6.0
//
