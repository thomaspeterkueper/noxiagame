...
export default function ColonyDetail({
  ...
  const panel: React.CSSProperties = {
    ...
    width: '100%', maxWidth: '560px', maxHeight: '88vh', overflowY: 'auto', padding: '1.5rem', color: '#e8e6df', fontFamily: 'system-ui, sans-serif',
  }
  ...
  return (
    <div style={overlay} onClick={onClose}>
      <div style={panel} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ marginBottom: '16px', border: '0.5px solid #1f3650', borderRadius: '8px', overflow: 'hidden' }}>
          <BuildingResidentsCard locationSlug={colony.slug} />
        </div>
        ...
        {isHere ? (
          ...
          <div title="Ziel außerhalb der Reichweite deines Schiffs" style={{ width: '100%', padding: '12px 0', fontSize: '0.9rem', borderRadius: '9px', border: '1px solid #3a4759', background: '#0f1722', color: '#7d93b0', textAlign: 'center', fontWeight: 600 }}>
