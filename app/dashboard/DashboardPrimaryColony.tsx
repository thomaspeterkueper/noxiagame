 ...
 * The world surface owns the viewport below the global top bar. Dashboard
 * information floats above it as HUD and must not reserve layout columns.
 */
.noxia-primary-colony{position:fixed;z-index:900;left:0;right:0;top:54px;bottom:0;overflow:hidden;background:#081019;box-shadow:none;display:block}
.noxia-primary-hudrail{position:absolute;z-index:170;left:0;right:0;top:0;height:54px;background:transparent;border:0;overflow:visible;pointer-events:none}
.noxia-primary-mapframe{position:absolute;z-index:1;inset:0;min-height:0;overflow:hidden;background:#081019}
...
.noxia-open-isometric{position:fixed;z-index:1180;left:50%;top:62px;transform:translateX(-50%);border:1px solid #2c78b6;border-radius:7px;background:#08243b;color:#e7f3fb;font:700 11px system-ui;padding:7px 12px;cursor:pointer;box-shadow:0 4px 14px rgba(0,0,0,.18)}
...
@media(max-width:900px){.noxia-primary-colony{top:54px}.noxia-primary-hudrail{height:48px}.noxia-open-isometric{top:60px}}
`}</style>
