...
.noxia-game-hud{position:relative;height:46px;z-index:140;pointer-events:none;font-family:system-ui,sans-serif;color:#e7eef4}
.noxia-resource-hud{position:absolute;top:7px;left:50%;transform:translateX(-50%);display:flex;gap:5px;max-width:58%;pointer-events:none}
...
.noxia-sim-status{position:absolute;left:10px;top:7px;display:flex;gap:7px;align-items:center;max-width:230px;height:32px;padding:0 8px;border:1px solid #9a703f;border-radius:6px;background:rgba(41,29,15,.9);font-size:9px}.noxia-sim-status b{color:#f1d57a;letter-spacing:.08em}.noxia-sim-status.critical{border-color:#a95050;background:rgba(50,20,20,.92)}.noxia-sim-status.critical b{color:#ff8f8f}.noxia-sim-status span{color:#d4c6b5;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.noxia-build-status{position:absolute;right:10px;top:7px;width:180px;height:32px;padding:4px 8px;border:1px solid rgba(74,99,119,.72);border-radius:6px;background:rgba(7,17,28,.82);box-shadow:0 3px 10px #0004;backdrop-filter:blur(7px);font-size:9px}.noxia-build-status span{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.noxia-build-status span b{color:#f1d57a;letter-spacing:.08em}.noxia-build-status em{display:block;margin-top:1px;text-align:right;font-size:8px;font-style:normal;color:#9eb1c0}.build-progress{height:3px;background:#1a2936;border-radius:4px;overflow:hidden;margin-top:3px}.build-progress i{display:block;height:100%;background:linear-gradient(90deg,#20a963,#67e49b)}
@media(max-width:1000px){.noxia-resource-hud{left:8px;right:8px;transform:none;max-width:none;overflow:hidden;justify-content:center}.noxia-resource-chip{min-width:72px}.noxia-build-status,.noxia-sim-status{display:none}}
`}</style> }
