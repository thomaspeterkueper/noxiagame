  ...
  rooms: [
    {
      ...
      capacity: 8,
      tags: ['entry', 'docking'],
      capabilities: ['station.docking'],
    },
    { id: 'transfer-corridor', levelId: 'deck-a', name: 'Transfer corridor', kind: 'corridor', capacity: 18, capabilities: ['cargo.transfer'] },
    { id: 'cargo-lock', levelId: 'deck-a', name: 'Cargo lock', kind: 'storage', capacity: 8, capabilities: ['inventory.storage', 'cargo.transfer'] },
    { id: 'habitat-hub', levelId: 'deck-b', name: 'Habitat hub', kind: 'habitation', capacity: 24, capabilities: ['crew.habitation'] },
    { id: 'medical-bay', levelId: 'deck-b', name: 'Medical bay', kind: 'medical', capacity: 6, capabilities: ['medical.general'] },
    { id: 'operations', levelId: 'deck-b', name: 'Station operations', kind: 'office', capacity: 10, capabilities: ['operations.station', 'administration.general'] },
    { id: 'service-spine', levelId: 'deck-c', name: 'Service spine', kind: 'corridor', capacity: 12 },
    { id: 'utilities', levelId: 'deck-c', name: 'Utilities', kind: 'technical', capacity: 6, capabilities: ['utilities.local'] },
    { id: 'depot', levelId: 'deck-c', name: 'Depot', kind: 'storage', capacity: 12, capabilities: ['inventory.storage', 'station.depot'] },
  ],
  portals: [
