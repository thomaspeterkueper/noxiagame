// orbits.ts
// Aktualisiert: 10.09.2026 — Kepler Station als kanonische Erde-Sonne-L5-Station
// Version:      0.2.1
// lib/game/orbits.ts
// Erstellt:     15.06.2026
//
...
// Mond↔Mars schwankt ~25–50s, kurze Hops (Mars↔Phobos, Erde↔Kepler Station) liegen
...
//   Kepler Station bleibt damit immer ~45 Einheiten von der Erde entfernt.
//
// Migrationshinweis:
//   `kepler` ist der neue kanonische Slug. `prometheus` bleibt vorübergehend als
//   technische Alias-Route erhalten, bis persistierte Location-/Ship-/Travel-
//   Referenzen in einer eigenen atomaren Datenmigration umgestellt sind.
