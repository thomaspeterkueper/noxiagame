...
const assistance: PopulationEvent = { id: 'event-42', tick: 42, eventType: 'person_assistance', actorPersonId: 'a', relatedPersonId: 'b', locationId: 'mars-alpha', subjectType: 'person', subjectRef: 'b', payload: {} }
const m1 = memoryFromPopulationEvent(assistance), m2 = memoryFromPopulationEvent(assistance)
...
check(memoryFromPopulationEvent({ ...assistance, id: 'event-43', eventType: 'npc_work' }) === null, 'unknown events do not invent memories')
check(memoryFromPopulationEvent({ ...assistance, id: 'event-44', eventType: 'npc_social_interaction', relatedPersonId: null }) === null, 'social memory requires explicit related person')
