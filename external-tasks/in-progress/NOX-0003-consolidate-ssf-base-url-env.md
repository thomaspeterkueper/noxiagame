...
## Acceptance note
Angenommen. NOXIA soll genau eine SSF-Basis-URL verwenden. `SSF_BASE_URL` wird der kanonische Name; `SSF_API_BASE_URL` darf höchstens noch als rückwärtskompatibler Alias mit gleichem Default behandelt werden.
