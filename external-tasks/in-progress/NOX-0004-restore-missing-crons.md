...
## Acceptance note
Angenommen. Preise und Orders sind Teil des Wirtschaftsloops und müssen entweder wieder als Cron laufen oder die Spezifikation muss bewusst geändert werden. Zuerst werden die vorhandenen `/api/cron/*`-Routen geprüft, dann `vercel.json` und `SETUP.md` synchronisiert.
