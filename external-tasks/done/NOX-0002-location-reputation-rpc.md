...
- `supabase/migrations/031_reputation_rpc.sql` committed `81b8fba`
- `app/api/game/trade/route.ts` v0.6.0 committed `5eea788`
- Migration im Supabase SQL-Editor ausgeführt (bestätigt durch Thomas)
