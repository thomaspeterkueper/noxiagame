...
The physical 497-person Tharsis Hub start seed is now merged. Individual population assignments may therefore use the stable seed objects in the dedicated follow-up task.
